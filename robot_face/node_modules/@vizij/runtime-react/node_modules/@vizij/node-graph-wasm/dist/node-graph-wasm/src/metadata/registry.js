const registry = {
    ...
    "nodes": [
        ...
        },
        {
            ...
            "name": "Sin",
            "category": "Math",
            "doc": "Computes the sine of the input angle (radians).",
            "inputs": [
                {
                    "id": "in",
                    "ty": "float",
        ...
        },
        {
            ...
            "name": "Cos",
            "category": "Math",
            "doc": "Computes the cosine of the input angle (radians).",
            "inputs": [
                {
                    "id": "in",
                    "ty": "float",
        ...
        },
        {
            ...
            "name": "Tan",
            "category": "Math",
            "doc": "Computes the tangent of the input angle (radians); results blow up near π/2 + kπ.",
            "inputs": [
                {
                    "id": "in",
                    "ty": "float",
        ...
        },
        {
            ...
            "name": "Vector Add",
            "category": "Vectors",
            "doc": "Element-wise sum of A and B; mismatched shapes produce NaN.",
            "inputs": [
                {
                    "id": "a",
                    "ty": "vector",
        ...
        {
            "type_id": "vectorsubtract",
            "name": "Vector Subtract",
            "category": "Vectors",
            "doc": "Element-wise subtraction A - B; mismatched shapes produce NaN.",
            "inputs": [
                {
                    "id": "a",
                    "ty": "vector",
        ...
        {
            "type_id": "vectormultiply",
            "name": "Vector Multiply",
            "category": "Vectors",
            "doc": "Element-wise product of A and B; mismatched shapes produce NaN.",
            "inputs": [
                {
                    "id": "a",
                    "ty": "vector",
        ...
        },
        {
            ...
            "name": "Vector Min",
            "category": "Vectors",
            "doc": "Returns the minimum element of In; empty vectors yield NaN.",
            "inputs": [
                {
                    "id": "in",
                    "ty": "vector",
        ...
        },
        {
            ...
            "name": "Vector Max",
            "category": "Vectors",
            "doc": "Returns the maximum element of In; empty vectors yield NaN.",
            "inputs": [
                {
                    "id": "in",
                    "ty": "vector",
        ...
        },
        {
            ...
            "name": "Vector Mean",
            "category": "Vectors",
            "doc": "Returns the arithmetic mean of In; empty vectors yield NaN.",
            "inputs": [
                {
                    "id": "in",
                    "ty": "vector",
        ...
        {
            "type_id": "vectormedian",
            "name": "Vector Median",
            "category": "Vectors",
            "doc": "Returns the median of In (average of middle pair for even counts); empty vectors yield NaN.",
            "inputs": [
                {
                    "id": "in",
                    "ty": "vector",
        ...
        },
        {
            ...
            "name": "Vector Mode",
            "category": "Vectors",
            "doc": "Returns the most frequent non-NaN value in In; ties choose the smallest value; empty vectors yield NaN.",
            "inputs": [
                {
                    "id": "in",
                    "ty": "vector",

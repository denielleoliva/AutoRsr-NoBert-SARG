const edge = (from, to, input, options = {}) => ({
    from: {
        node_id: from,
...
const textValue = (text) => ({ type: "text", data: text });
/**
 ...
 */
export const tupleSpringDampSlew = {
    nodes: [
        {
            id: "pair",
            type: "input",
 ...
 */
export const nestedRigWeightedPose = {
    nodes: [
        {
            id: "config",
            type: "input",
 ...
 */
export const hierarchicalBlend = {
    nodes: [
        {
            id: "rig",
            type: "input",

 ...
 */
import type { Float, Bool, Text, Vec2, Vec3, Vec4, Quat, ColorRgba, Vector, EnumVal, RecordVal, ArrayVal, ListVal, TupleVal, Transform, ValueJSON, NormalizedValue } from "@vizij/value-json";
export type { Float, Bool, Text, Vec2, Vec3, Vec4, Quat, ColorRgba, Vector, EnumVal, RecordVal, ArrayVal, ListVal, TupleVal, Transform, ValueJSON, NormalizedValue, };
 ...
 */
export type ShapeJSON = ShapePrimitive | {
    record?: ShapeField;
} | {
    array?: ShapeJSON;
} | any;
...
export type MergeConflictStrategy = "error" | "namespace" | "blend" | "blend_equal" | "blend_equal_weights" | "add" | "sum" | "blend_sum" | "blend-sum" | "additive" | "default_blend" | "default-blend" | "blend-default" | "blend_weights" | "blend-weights" | "weights";
